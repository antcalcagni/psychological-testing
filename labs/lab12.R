...
# [A] WISC-IV: dati -------------------------------------------------------
load("laboratorio/wisc_simdata.Rdata")
str(wisc)
head(wisc)
...
# bambini a sviluppo atipico (group="atipici"). I dati simulati comprendono i 10 items della WISC-IV (modulo D, slides 47-48) che sottendono, come da teoria,
...
# Per la parte teorica si vedano le slides 60-73 del modulo D.
...
# Checklist per l'analisi dell'invarianza: http://joophox.net/publist/CecklistMeasInv.pdf
...
# Strong invariance, also called "scalar invariance", implies that the meaning of the construct (the factor loadings), and the levels of the underlying items (intercepts) 
