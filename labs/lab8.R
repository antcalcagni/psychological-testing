...
# Variabile chr contenente il modello: il simbolo =~ indica relazione fattore-item, + indica la componente additiva della scala, a destra di =~ scriviamo il nome del
...
# Nota: lambda_x1 = 1 sempre a causa della parametrizzazione ULI (default).
...
model.visual = "visual =~ x1+x2+0.9*x3 \n x1~~x3" #correlando gli errori delle variabili x1,x3
...
# Un modello con fattore sovraordinato (esempio modello M4, slide 57 del modulo D) è un modello CFA con l'aggiunta di 
...
# ..confronto tramite test chi-quadrato (slide 62 del modulo D)
anova(cfa.m0,cfa.m1)
